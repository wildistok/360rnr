 ...
 * @author Peter Abeles
 */
public class PanoBoofCvImpl implements Pano {
     ...
     * it can do alone.
     */
    private static GrayU8 createMask(CameraUniversalOmni model,
    ...
    public BufferedImage panoWritter(String file1, String file2, String fisheyePath) {
        ...
        BufferedImage buffered0 = UtilImageIO.loadImage(fisheyePath, file2);
        BufferedImage buffered1 = UtilImageIO.loadImage(fisheyePath, file1);
    ...
    public BufferedImage panoWritter(BufferedImage buffered0, BufferedImage buffered1, String fisheyePath) {
        ...
        CameraUniversalOmni model1 = CalibrationIO.load(new File(fisheyePath, "back1.yaml"));
        ...
        MultiCameraToEquirectangular<Planar<GrayF32>> alg = new MultiCameraToEquirectangular<Planar<GrayF32>>(distort, 1280, 640, imageType);
        ...
        GrayU8 mask0 = PanoBoofCvImpl.createMask(model0, distort0, UtilAngle.radian(182)); // camera has a known FOV of 185 degrees
        GrayU8 mask1 = PanoBoofCvImpl.createMask(model1, distort1, UtilAngle.radian(182)); // the edges are likely to be noisy,
        // so crop it a bit..
        ...
        List<Planar<GrayF32>> images = new ArrayList<Planar<GrayF32>>();
        images.add(fisheye0);
        images.add(fisheye1);
